...
Route::group(['prefix' => 'admin', 'middleware' => 'is_admin'], function () {
    ...
    Route::get('/settings', Admin/SettingsController::class)->name('admin.settings');
    Route::get('/users', Admin/UsersController::class)->name('admin.users');});

// Task 11: point URL /admin/stats to a "Single Action" Admin/StatsController
// Put one code line here below
Route::get('/admin/stats', Admin/StatsController::class)->name('admin.stats');
